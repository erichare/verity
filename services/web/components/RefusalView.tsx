...
export default function RefusalView({ result }: { result: RefusalResponse }) {
  ...
  return (
    <div className="glass space-y-5 rounded-2xl border-oxblood/30 p-6 sm:p-8">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <p className="text-xs uppercase tracking-wider text-oxblood/80">Out of scope</p>
        ...
        <span className="rounded-full border border-oxblood/30 bg-oxblood/12 px-3 py-1 text-sm font-medium text-oxblood">
          refused
        </span>
      </div>
