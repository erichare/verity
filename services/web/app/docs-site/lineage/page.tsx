        ...
        <Reveal className="mt-12">
          <div className="glass rounded-2xl p-6 sm:p-7">
            ...
            <p className="mt-2 max-w-2xl text-sm leading-relaxed text-foreground/75">
              The validation report and the per-comparison report are generated from the live engine
              on public benchmark data. The technical white paper is authored — the written account of
