...
`cartridge_fadul.npz` contains *derived* per-pair areal cross-correlation scores
and KM/KNM labels (not the scans) computed by Verity from the **Fadul**
cartridge-case breech-face scans, used only to calibrate and scope the impressed-
